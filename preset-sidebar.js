(function() {
  ...
  // AO3 uses hidden inputs for tag strings
  ...
  function readPresetFromForm() {
    ...
    return {
      ...
      fandoms: safeTags("input[name='work[fandom_string]']"),
      relationships: safeTags("input[name='work[relationship_string]']"),
      characters: safeTags("input[name='work[character_string]']"),
      tags: safeTags("input[name='work[freeform_string]']")
    };
  }
  ...
  function applyPresetToForm(preset, bundles) {
    ...
    setTags("input[name='work[fandom_string]']", preset.fandoms || []);
    setTags("input[name='work[relationship_string]']", preset.relationships || []);
    setTags("input[name='work[character_string]']", preset.characters || []);

    var expandedTags = expandBundles(preset.tags || [], bundles || []);
    setTags("input[name='work[freeform_string]']", expandedTags);
  }
